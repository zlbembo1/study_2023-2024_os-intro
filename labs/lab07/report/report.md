...
Можно использовать историю команд и применить команду из истории, я применил копирование файла (рис. @fig:013).
...
Командой touch text.txt создал файл (рис. @fig:020).

![Создание файла](image/20.png){#fig:020 width=70%}

Клавишей F4 открыл файл для записи, добавила в него текст (рис. @fig:021).
...
Я отключил подсветку и вывела снова тот же самый файл, но уже без подсветки (рис. @fig:030).
